...
BEGIN;
INSERT INTO users (id, username, password, address, addressee, avatar, balance, birthday, nickname, phone, sex, signature) VALUES (1, 'system', 'system', null, null, null, 0, null, null, null, null, null);
INSERT INTO users (id, username, password, address, addressee, avatar, balance, birthday, nickname, phone, sex, signature) VALUES (2, 'ch', '123', '上海市闵行区 东川路800号 上海交通大学', '池昊', '143873758.jpg', 200, '2014-12-31T16:00:00.000Z', 'admin', '15517597867', 'male', '这人是个懒狗，什么都没有写');
INSERT INTO users (id, username, password, address, addressee, avatar, balance, birthday, nickname, phone, sex, signature) VALUES (3, 'user1', '123', null, null, null, 0, null, null, null, null, null);
INSERT INTO users (id, username, password, address, addressee, avatar, balance, birthday, nickname, phone, sex, signature) VALUES (4, 'user2', '123', null, null, null, 0, null, null, null, null, null);
COMMIT;
...
BEGIN;
INSERT INTO orders (id, user_id, create_time, address, addressee, phone) VALUES (1, 1, '2024-4-28 14:16:32', '购物车订单', 'system', '0');
...
CREATE TABLE IF NOT EXISTS `order_items` (
    ...
    `number` INT not null,
    CONSTRAINT `order_items_fk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
    CONSTRAINT `order_items_fk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`),
    CONSTRAINT `order_items_fk_3` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

BEGIN;
INSERT INTO order_items (id, user_id, book_id, order_id, number) VALUES (1, 2, 1, 1, 1);
INSERT INTO order_items (id, user_id, book_id, order_id, number) VALUES (2, 2, 4, 1, 1);
INSERT INTO order_items (id, user_id, book_id, order_id, number) VALUES (3, 2, 7, 2, 2);
INSERT INTO order_items (id, user_id, book_id, order_id, number) VALUES (4, 2, 1, 3, 1);
INSERT INTO order_items (id, user_id, book_id, order_id, number) VALUES (5, 1, 1, 1, 1);
COMMIT;
...
CREATE TABLE IF NOT EXISTS `cart_items` (
    ...
    `number` INT not null,
    CONSTRAINT `cart_items_fk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
    CONSTRAINT `cart_items_fk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`),
    CONSTRAINT `cart_items_fk_3` FOREIGN KEY (`cart_id`) REFERENCES `carts` (`id`)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

BEGIN;
INSERT INTO cart_items (id, user_id, book_id, cart_id, number) VALUES (1, 2, 1, 1, 1);
INSERT INTO cart_items (id, user_id, book_id, cart_id, number) VALUES (2, 2, 4, 1, 1);
INSERT INTO cart_items (id, user_id, book_id, cart_id, number) VALUES (3, 2, 7, 2, 2);
INSERT INTO cart_items (id, user_id, book_id, cart_id, number) VALUES (4, 2, 1, 3, 1);
INSERT INTO cart_items (id, user_id, book_id, cart_id, number) VALUES (5, 1, 1, 1, 1);
COMMIT;
