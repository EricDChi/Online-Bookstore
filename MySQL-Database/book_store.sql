...
BEGIN;
INSERT INTO book_store.orders (id, user_id, address, addressee, phone, total_price) VALUES (1, 1, '购物车订单', 'system', '0', 0);
INSERT INTO book_store.orders (id, user_id, address, addressee, phone, total_price) VALUES (2, 2, 'test_address', '池昊', '15517597867', 50);
INSERT INTO book_store.orders (id, user_id, address, addressee, phone, total_price) VALUES (3, 2, 'test_address', 'chihao', '15517597867', 30);
INSERT INTO book_store.orders (id, user_id, address, addressee, phone, total_price) VALUES (4, 3, '东川路800号', 'test_addressee', '15517597867', 20);
COMMIT;
...
BEGIN;
INSERT INTO book_store.orderitems (id, user_id, book_id, order_id, number, pay_price, status) VALUES (1, 2, 1, 1, 1, 20, 1);
INSERT INTO book_store.orderitems (id, user_id, book_id, order_id, number, pay_price, status) VALUES (2, 2, 4, 1, 1, 30, 1);
INSERT INTO book_store.orderitems (id, user_id, book_id, order_id, number, pay_price, status) VALUES (3, 2, 7, 2, 2, 10, 1);
INSERT INTO book_store.orderitems (id, user_id, book_id, order_id, number, pay_price, status) VALUES (4, 2, 1, 3, 1, 50.5, 1);
INSERT INTO book_store.orderitems (id, user_id, book_id, order_id, number, pay_price, status) VALUES (5, 1, 1, 1, 1, 50, 0);
COMMIT;